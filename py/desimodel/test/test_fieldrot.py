...
class TestFieldRot(unittest.TestCase):
    ...
    def test_xyz_radec_transfo(self):
        ...
        self.assertTrue(np.allclose(ra, tra))
        self.assertTrue(np.allclose(dec, tdec))
